 ...
 */
final class Version20250113091505 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission CHANGE status status VARCHAR(255) DEFAULT \'pending\' NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mission CHANGE status status VARCHAR(255) NOT NULL');
    }
}
